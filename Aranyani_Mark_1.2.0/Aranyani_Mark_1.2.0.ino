...
* Added a relay to control lights of the rover.
* set the remote stick configuration  to mode 2.
* this code is specifically modified for used with raspberry pi pico only.
 */

int channel1= 0; // for reciving input from channel 1.
int channel2= 1; // for reciving input from channel 2.
int channel5= 2; // for reciving input from channel 5.
int channel6= 3; // for reciving input from channel 6. This is a resrved channel no use till now
int Switch = 4;  // for turning on or off a realy or a mosfet. 
int pwm1 = 5;    // for outputing pwm signal to motor driver 1.
int pwm2 = 6;    // for outputing pwm signal to motor driver 2.
int dir1 = 7;     // for outputing direction value to motor driver 1.
int dir2 = 8;     // for outputing direction value to motor driver 2.
const int ledPin =  25; // for outputing a visual signal needed for trouble shooting. This is the led on pin number 25
...
void setup()
{
  ...
  digitalWrite(Switch, HIGH);  // this will keep the relay off initialy 
...
void loop()
{
  ...
  {                                     // relay or switch on.
    ...
    digitalWrite(Switch, LOW);         // this will turn on the switch.           
  }
  ...
  {                                     // relay or switch on.
    ...
    digitalWrite(Switch, HIGH);          // this will turn off the switch.     
  }
 ...
 blink(); // using the void blink Function . to blink the led 

}

// this led blinking function is for just troubleshooting 
